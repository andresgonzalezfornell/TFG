...
stairs(handles.salida_espectro,f,abs(handles.Y_R),'red')
stairs(handles.salida_espectro,f,abs(handles.Y_L),'green')
set(handles.salida_espectro,'color',[0.05 0.05 0.1])
