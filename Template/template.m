...
%       <Efecto>        por nombre del efecto siguiendo el formato (ej.: Overdrive)
%       <EFECTO>        por nombre del efecto siguiendo el formato (ej.: OVERDRIVE)
%       <Descripcion>   por la descripción del efecto
%   Implementar el efecto en la función aplicar_callback.
%   Implementar los parámetros en las funciones par_<#>_Callback y par_<#>_value_Callback
%   Implementar la ampliación del gráfico de representación del efecto en el gráfico handles.graf_open
...
%
% Inicialización de parámetros (ejemplo con parámetro 1)
%   handles.parametro1 = 0;         % Valor inicial parámetro 1
%   handles.limites(1).Min = 0;     % Valor mínimo parámetro 1
%   handles.limites(1).Max = 1;     % Valor máximo parámetro 1
%   set(handles.par_1,'Visible','on','Value',handles.BW)
%   set(handles.par_1_value,'Visible','on','String',handles.parametro1)
%   set(handles.par_1_title,'Visible','on','String','Nombre parámetro 1')
