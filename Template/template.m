...
%       <Efecto>        por nombre del efecto siguiendo el formato (ej.: Overdrive)
%       <EFECTO>        por nombre del efecto siguiendo el formato (ej.: OVERDRIVE)
%       <Descripci�n>   por la descripción del efecto
%   Implementar el efecto en la función aplicar_callback.
%   Implementar los parámetros en las funciones par_<#>_Callback
%   Implementar la descripci�n del efecto en la funci�n <efecto>_OpeningFcn
%   Implementar la ampliaci�n del gr�fico de representaci�n del efecto en la funci�n graf_open_Callback
